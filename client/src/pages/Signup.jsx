          ...
          >
            ...
            >
              ...
              <div className="bg-white/70 dark:bg-gray-800/70 p-8 rounded-2xl shadow-xl backdrop-blur-xl border border-white/20 relative">
                ...
                >
                  <FiUserPlus className="w-full h-full text-white" />
                </motion.div>
                ...
                <form onSubmit={handleSubmit(handleSignup)} className="space-y-6">
                  ...
                  >
                    <FiUser className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-indigo-500 transition-colors" />
                    <Textbox
                      type="text"
                      label="Full Name"
                    ...
                    >
                      ...
                      <div className="relative flex items-center justify-center gap-2">
                        {isLoading ? (
                          ...
                          <>
                            <span className="text-sm uppercase tracking-wider font-semibold">Sign Up</span>
